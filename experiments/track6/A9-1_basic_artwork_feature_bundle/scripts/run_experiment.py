#!/usr/bin/env python3
"""Run A9-1_basic_artwork_feature_bundle with the fixed Track6 variable experiment runner."""
...
CONFIG = REPO / "experiments" / "track6" / "A9-1_basic_artwork_feature_bundle" / "experiment_config.json"
