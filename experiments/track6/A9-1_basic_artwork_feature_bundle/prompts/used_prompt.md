...
- 호수, NANT 재료, NANT 지지체를 기준으로 작품 기본 피처 묶음을 정의한다.
...
- 호수 + 로그면적 + NANT 재료 + NANT 지지체: `ln_estimated_ho, log_area, nant_material_idx, nant_tool, nant_support`
