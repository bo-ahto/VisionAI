...
|---|---|---|---:|---:|---:|---:|
| `cold` | `routed_by_meta_bin` | `meta_bin` | `0.3440` | `0.6007` | `1.8721` | `0.6555` |
| `cold` | `baseline_cold_lightgbm` | `baseline` | `0.3851` | `0.7169` | `2.0250` | `0.6901` |

## 코멘터리

- `cold` best `routed_by_meta_bin`: baseline 대비 MdAPE `-0.0411`, MAPE `-0.1162`, p95 `-0.1529`.
