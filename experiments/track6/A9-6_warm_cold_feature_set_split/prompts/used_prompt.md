...
- Warm과 Cold에서 같은 작품 피처 묶음을 써도 되는지, 분리 후보가 필요한지 확인한다.
...
- 공통 기본 후보: `ln_estimated_ho, nant_material_idx, nant_tool, nant_support`
- 공통 로그면적 후보: `log_area, nant_material_idx, nant_support`
- Warm 후보: 전체 크기 + 원문 재료 묶음 + NANT 지지체: `ln_estimated_ho, log_area, width_cm, height_cm, collected_material_raw_bucket, nant_support`
- Cold 후보: 로그면적 + 수집 재료 대분류 + 수집 지지체 대분류: `log_area, medium_category, support_category`
