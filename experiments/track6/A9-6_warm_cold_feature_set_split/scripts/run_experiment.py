#!/usr/bin/env python3
"""Run A9-6_warm_cold_feature_set_split with the fixed Track6 variable experiment runner."""
...
CONFIG = REPO / "experiments" / "track6" / "A9-6_warm_cold_feature_set_split" / "experiment_config.json"
