...
## 사용 피처
- J3 기준: 세대/경력 + 지지체: `artist_meta_birth_year, artist_exhibition_solo_count, artist_exhibition_group_count, artist_exhibition_fair_count, nant_support` - 개별 효과만 사용
- J3 교차항: 세대/경력 x 지지체: `artist_meta_birth_year, artist_exhibition_solo_count, artist_exhibition_group_count, artist_exhibition_fair_count, nant_support` - 세대/경력별 지지체 프리미엄 추가
