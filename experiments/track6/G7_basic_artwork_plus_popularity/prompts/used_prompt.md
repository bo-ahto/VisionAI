...
- 작품 기본 피처 + 인지도: `ln_estimated_ho, nant_material_idx, nant_tool, nant_support, artist_meta_followers, artist_meta_is_p1` - 작품 조건 통제 후 팔로워 수와 주요 작가 여부 추가
- 작품 기본 피처 + 인지도 + 결측: `ln_estimated_ho, nant_material_idx, nant_tool, nant_support, artist_meta_followers, artist_meta_is_p1, artist_meta_followers_is_missing, artist_meta_is_p1_is_missing` - 인지도 값과 결측 상태 추가
