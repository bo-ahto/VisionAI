...
- 수집 지지체 대분류와 NANT 지지체 중 어떤 표현이 더 안정적인지 확인한다.
...
- 로그면적 + NANT 재료 번호 + 수집 지지체 대분류: `log_area, nant_material_idx, support_category`
- 로그면적 + NANT 재료 번호 + NANT 지지체: `log_area, nant_material_idx, nant_support`
- 로그면적 + NANT 재료 번호 + 수집 지지체 + NANT 지지체: `log_area, nant_material_idx, support_category, nant_support`
