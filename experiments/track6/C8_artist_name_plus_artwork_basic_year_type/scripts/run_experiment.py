#!/usr/bin/env python3
"""Run Track6 C8 artist_name_ko plus artwork basic bundle, year, and type experiment."""
...
if __name__ == "__main__":
    config = REPO / "experiments" / "track6" / "C8_artist_name_plus_artwork_basic_year_type" / "experiment_config.json"
