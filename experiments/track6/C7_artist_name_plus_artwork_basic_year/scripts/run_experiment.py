#!/usr/bin/env python3
"""Run Track6 C7 artist_name_ko plus artwork basic bundle and year experiment."""
...
if __name__ == "__main__":
    config = REPO / "experiments" / "track6" / "C7_artist_name_plus_artwork_basic_year" / "experiment_config.json"
