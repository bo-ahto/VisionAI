#!/usr/bin/env python3
"""Run Track6 C6 artist_name_ko plus artwork basic feature bundle experiment."""
...
if __name__ == "__main__":
    config = REPO / "experiments" / "track6" / "C6_artist_name_plus_artwork_basic" / "experiment_config.json"
