...
## 사용 피처
- J1 기준: 호수 + 세대/경력: `ln_estimated_ho, artist_meta_birth_year, artist_exhibition_solo_count, artist_exhibition_group_count, artist_exhibition_fair_count` - 개별 효과만 사용
- J1 교차항: 세대/경력 x 호수: `ln_estimated_ho, artist_meta_birth_year, artist_exhibition_solo_count, artist_exhibition_group_count, artist_exhibition_fair_count, birth_year_x_ln_ho, artist_exhibition_solo_count_x_ln_ho, artist_exhibition_group_count_x_ln_ho, artist_exhibition_fair_count_x_ln_ho` - 세대/경력별 호수 프리미엄 추가
