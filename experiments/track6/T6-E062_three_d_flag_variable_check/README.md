# T6-E062 3D 후보 플래그 변수 영향 확인

- 단계: 기본 피처 정의 - 개별 변수 확인
- 가설: 3D 후보 플래그 변수는 2D 작품과 3D 작품의 가격 예측 차이를 설명한다.
- 확인 변수: `has_depth + is_3d_candidate`
...
- Warm 변수 추가 모델 학습 피처: `artist_name_ko + ln_estimated_ho + has_depth + is_3d_candidate`
- Warm 테스트 피처: 학습 피처와 같은 컬럼 사용
- Cold 기준 모델 학습 피처: `ln_estimated_ho`
- Cold 변수 추가 모델 학습 피처: `ln_estimated_ho + has_depth + is_3d_candidate`
