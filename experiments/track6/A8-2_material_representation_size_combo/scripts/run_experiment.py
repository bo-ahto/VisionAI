#!/usr/bin/env python3
"""Run A8-2 with the fixed Track6 variable experiment runner."""
...
CONFIG = REPO / "experiments" / "track6" / "A8-2_material_representation_size_combo" / "experiment_config.json"
