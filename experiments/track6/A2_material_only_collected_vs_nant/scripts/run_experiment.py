#!/usr/bin/env python3
"""Run A2 with the fixed Track6 variable experiment runner.
...
Only `experiment_config.json` changes the tested variable blocks.
"""
...
CONFIG = REPO / "experiments" / "track6" / "A2_material_only_collected_vs_nant" / "experiment_config.json"
