...
## 사용 피처
- J6 기준: 기본 프로필 + 재료: `artist_meta_birth_year, artist_exhibition_solo_count, artist_exhibition_group_count, artist_exhibition_fair_count, artist_meta_nationality, nant_material_idx, nant_tool` - 개별 효과만 사용
- J6 교차항: 기본 프로필 x 재료: `artist_meta_birth_year, artist_exhibition_solo_count, artist_exhibition_group_count, artist_exhibition_fair_count, artist_meta_nationality, nant_material_idx, nant_tool, nationality_material_idx_combo, nationality_tool_combo` - 세대/경력/국적별 재료 프리미엄 추가
