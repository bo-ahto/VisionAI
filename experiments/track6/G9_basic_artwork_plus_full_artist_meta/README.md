# Track6 G9 작품 기본 피처 + 전체 작가 메타 실험 결과

- 실험 목적: 작품 조건을 통제한 후 전체 작가 메타 묶음이 가격 예측력을 높이는지 확인
- 학습 데이터 건수: `26,914`건
- Warm 테스트 건수: `607`건
- Cold 테스트 건수: `3,099`건
- Warm 최고: `작품 기본 피처 + 전체 작가 메타` / `Huber` / MdAPE `0.4390`
- Cold 최고: `작품 기본 피처 + 전체 작가 메타` / `LightGBM` / MdAPE `0.4684`
- 사용 코드: `scripts/track6/fixed_variable_experiment_runner.py`
- 사용 설정: `experiments/track6/G9_basic_artwork_plus_full_artist_meta/experiment_config.json`
- 사용 프롬프트: `experiments/track6/G9_basic_artwork_plus_full_artist_meta/prompts/used_prompt.md`
...
- summary: Warm 최고는 작품 기본 피처 + 전체 작가 메타 + Huber(MdAPE 0.4390), Cold 최고는 작품 기본 피처 + 전체 작가 메타 + LightGBM(MdAPE 0.4684)이다.
