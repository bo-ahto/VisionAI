# T6-E056 면적/로그면적 변수 영향 확인

- 단계: 기본 피처 정의 - 개별 변수 확인
- 가설: 면적과 로그면적 변수는 작품 크기 효과를 정리해 가격 예측에 영향을 미친다.
- 확인 변수: `area_cm2 + log_area`
...
- Warm 변수 추가 모델 학습 피처: `artist_name_ko + ln_estimated_ho + area_cm2 + log_area`
- Warm 테스트 피처: 학습 피처와 같은 컬럼 사용
- Cold 기준 모델 학습 피처: `ln_estimated_ho`
- Cold 변수 추가 모델 학습 피처: `ln_estimated_ho + area_cm2 + log_area`
