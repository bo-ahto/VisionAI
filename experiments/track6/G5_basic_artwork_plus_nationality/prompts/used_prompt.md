...
- 작품 기본 피처 + 국적: `ln_estimated_ho, nant_material_idx, nant_tool, nant_support, artist_meta_nationality` - 작품 조건 통제 후 국적 추가
- 작품 기본 피처 + 국적 + 결측: `ln_estimated_ho, nant_material_idx, nant_tool, nant_support, artist_meta_nationality, artist_meta_nationality_is_missing` - 국적 값과 결측 상태 추가
