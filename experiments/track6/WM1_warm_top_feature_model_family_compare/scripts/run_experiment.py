#!/usr/bin/env python3
"""Run Track6 WM1 Warm model-family comparison.

This experiment fixes Warm top feature sets and changes only the model family.
It is separate from the fixed variable runner because the model list is wider
than the standard A-J variable experiments.
"""
