# T6-E057 가로세로 비율 변수 영향 확인

- 단계: 기본 피처 정의 - 개별 변수 확인
- 가설: 가로세로 비율 변수는 같은 크기라도 형태 차이에 따른 가격 예측에 영향을 미친다.
- 확인 변수: `aspect_ratio`
...
- Warm 변수 추가 모델 학습 피처: `artist_name_ko + ln_estimated_ho + aspect_ratio`
- Warm 테스트 피처: 학습 피처와 같은 컬럼 사용
- Cold 기준 모델 학습 피처: `ln_estimated_ho`
- Cold 변수 추가 모델 학습 피처: `ln_estimated_ho + aspect_ratio`
