...
- 작품 기본 피처 + 활동량: `ln_estimated_ho, nant_material_idx, nant_tool, nant_support, artist_meta_total_works, artist_meta_for_sale_works` - 작품 조건 통제 후 등록 작품 수와 판매 중 작품 수 추가
- 작품 기본 피처 + 활동량 + 결측: `ln_estimated_ho, nant_material_idx, nant_tool, nant_support, artist_meta_total_works, artist_meta_for_sale_works, artist_meta_total_works_is_missing, artist_meta_for_sale_works_is_missing` - 활동량 값과 결측 상태 추가
