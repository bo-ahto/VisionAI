...
|---|---:|---:|---:|---:|---:|---:|---|---:|---:|---:|---:|
| artsy | `30,046` | `11,118` / `37.00%` | `4,140,000` | `140` | `4,260` | `1,924` | `mixed_media` | `19,122` | `373` | `793` | `1,323` |
...
| saatchi | `21,721` | `21,721` / `100.00%` | `2,559,900` | `772` | `3,595` | `41` | `acrylic` | `772` | `20` | `317` | `1,803` |
