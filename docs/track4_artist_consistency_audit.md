...
|---|---:|---:|---:|---:|---:|---:|---:|---:|---:|---:|
| artsy | `30,046` | `30,044` | `2` | `1,898` | `30,044` | `0` | `30,046` | `26,611` | `30,046` | `5.89` |
| artue | `2,783` | `2,783` | `0` | `360` | `2,783` | `0` | `2,783` | `0` | `2,781` | `1.00` |
| gallery_primary | `292` | `292` | `0` | `78` | `292` | `0` | `0` | `292` | `292` | `3.00` |
| saatchi | `21,721` | `21,721` | `0` | `820` | `21,721` | `0` | `21,721` | `1,975` | `0` | `3.09` |

## 2. 한글 작가명 매핑 출처

| 매핑 출처 | rows |
|---|---:|
| `track3_mapping` | `54,548` |
| `raw_ko` | `292` |
| `missing` | `2` |
