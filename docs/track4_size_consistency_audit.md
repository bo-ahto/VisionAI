...
|---|---:|---:|---:|---:|---:|---:|---:|---:|---:|
| artsy | `30,046` | `29,673` | `373` | `65` | `61` | `4,260` | `2,500,000,000` | `7,125` | `1,924` |
| artue | `2,783` | `2,776` | `7` | `53` | `60` | `3,445` | `160,000` | `1,672` | `87` |
| gallery_primary | `292` | `291` | `1` | `75` | `65` | `5,071` | `420,000` | `0` | `0` |
| saatchi | `21,721` | `21,701` | `20` | `60` | `55` | `3,595` | `162,709` | `21,721` | `41` |

## 2. 이슈 카운트

| 이슈 | 건수 | 해석 |
|---|---:|---|
| `depth_over_100cm` | `176` | 깊이 1m 초과, 3D/설치 작품 또는 파싱 오류 후보 |
| `missing_width_cm` | `97` | 표준 가로값이 없음 |
| `missing_height_cm` | `93` | 표준 세로값이 없음 |
| `aspect_ratio_over_10` | `80` | 긴 변이 짧은 변의 10배 초과 |
