...
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
  ...
  대응 전략:
    ...
    2. Sprint 1에서 "회차 순서 = 실제 시간 순서" 가정이 맞는지 검증:
       → 같은 타입 내에서 회차가 단조증가하는지 확인
       → 역전 케이스가 있으면 개수 보고 + 해당 건 제외 여부 결정
...
```
  ...
  □ D등급 UX 결정 완료 (예측 범위 표시 / 예측 불가 / 추정가만 표시)
  □ 재변환 편향 검증 통과 (median(P̂/P) ≥ 0.85 모든 가격대)
