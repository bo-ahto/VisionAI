...
## 1. 산출물 인덱스 (총 18개 항목 = README + 17종 문서; 최종보고서는 .md/.html 동일 내용 2개 파일; Phase A 배치 사전 준비는 4 파일 묶음 단일 항목)

### 1.1 청중별 권장 시작 문서

| 대상 | 시작 문서 | 분량 |
|---|---|---|
| **종합 대시보드** ⭐ | `docs/트랙2_종합대시보드_20260507.html` | 5분 — 의사결정 + 진행 + 다음 단계 한눈 |
...
| 4. 최종 결과 보고서 | `docs/트랙2_최종보고서_20260506.md` + `.html` (동일 내용) |
