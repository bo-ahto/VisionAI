...
| T6-H6 | T6-G6 | 최종 후보는 validation뿐 아니라 test에서도 같은 방향의 성능을 보여야 한다 | validation에서 고른 후보만 test에 적용 | Track6 name-corrected split | 최종 후보 피처 | validation 성능 | test 성능 급락 없음 | 검증 완료 | test holdout 확인 | Warm test `0.3407` (주의 유지), Cold median test `0.3799` (주의 유지), Cold tail p95 `2.2865` (주의 유지) | T6-E006, T6-E007 | T6-E008 신뢰도 정책 진행 |
| T6-H7 | T6-G7 | Cold는 위험 구간을 나누어 신뢰도 경고를 제공해야 실무적으로 해석 가능하다 | 3D, 대형, 소형, 비균형 형태, 저이력 구간별 오차 비교 | Track6 name-corrected split | risk flags | Cold/Warm 전체 | 위험 구간 오차가 명확히 높음 | 검증 완료 | test slice 분석 | 위험 후보 `11`개, 대표 위험 `huber_cold__base_size_shape / 3d median 1.3504` | T6-E008 | T6-E009 최종 정리 |
