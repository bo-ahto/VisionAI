...
- 성공률: 1.0000
- 임베딩 shape: `(600, 512)`
- 임베딩 파일: `data/track6/image_multimodal/track6_clip_cold_pilot_600_embeddings.npy`
- 인덱스 파일: `data/track6/image_multimodal/track6_clip_cold_pilot_600_index.csv`
- 실패 파일: `data/track6/image_multimodal/track6_clip_cold_pilot_600_failures.csv`
