#!/usr/bin/env python3
"""Step 08B: copy and verify frozen-reference output."""
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Step 08B: copy and verify frozen output.")
    parser.add_argument(
        "--output-dir",
        type=Path,
