...
- 생성일: `2026-05-18`
- 기준: 모델 번들 frozen split
- 입력: `data/track6/track6_feature_candidates_name_corrected.csv`
- random seed: `20260518`
- 상태: `pass`
- frozen 경로: `models/track6/price_prediction_v0.1/data/training/track6_split/`
- 주의: `data/track6_split/`은 작업용 산출물이며, 기존 Track6 모델 학습/평가 재현 기준은 frozen split이다.
...
| split | rows | 작가 수 | 한글명 수 | 가격 중앙값 | 가격 p90 | 작가당 rows 중앙값 | 1작품 작가 수 | frozen 파일 |
|---|---:|---:|---:|---:|---:|---:|---:|---|
| `train` | `26,914` | `1,773` | `1,713` | `3,008,400` | `19,039,500` | `5.0` | `245` | `models/track6/price_prediction_v0.1/data/training/track6_split/track6_train.csv` |
| `val_warm` | `519` | `178` | `178` | `3,036,000` | `19,798,920` | `3.0` | `0` | `models/track6/price_prediction_v0.1/data/training/track6_split/track6_val_warm.csv` |
| `test_warm` | `607` | `207` | `205` | `2,829,000` | `18,802,180` | `3.0` | `0` | `models/track6/price_prediction_v0.1/data/training/track6_split/track6_test_warm.csv` |
| `val_cold` | `2,753` | `172` | `168` | `2,622,000` | `12,249,312` | `5.0` | `28` | `models/track6/price_prediction_v0.1/data/training/track6_split/track6_val_cold.csv` |
| `test_cold` | `3,099` | `200` | `189` | `3,450,000` | `20,087,280` | `6.0` | `33` | `models/track6/price_prediction_v0.1/data/training/track6_split/track6_test_cold.csv` |
...
- 기존 Track6 모델 성능표와 fixed test 결과는 이 frozen split 기준으로 해석한다.
- 현재 코드로 `data/track6_split/`을 새로 생성하면 row 수가 달라질 수 있으므로, 기존 모델 재현과 새 데이터셋 생성을 구분한다.
